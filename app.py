...
with gr.Blocks() as demo:
    gr.TabbedInterface([tabs.chat_interface.chat_interface, tabs.parameters.parameters], ["Chat", "Parameters"])
    demo.load(fn=load_data, inputs=None, outputs=[ui.pa_models, ui.ci_models])
